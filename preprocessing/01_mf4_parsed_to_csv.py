...
class Mf4Data:
    def __init__(self, abs_path, vehicle_name) -> None:
        """
        Initialize the Mf4Data class.
        ...
        """
        self.mf4 = None
        self.mf4_path = os.path.join(abs_path, vehicle_name) 
    ...
    def datetime_to_datetime(self):
        ...
        """
        if 'datetime' not in self.mf4.columns:
    ...
    def convert_bytes(self):
        """ 
        Convert specified columns from byte to float 
        """
    ...
    def get_session_labels(self):
        """ 
        Generate sessions based on time-intervals and pause time 
        """
    ...
    def signal_mapping(self):
        """ 
        Map signal values to predefined categories 
        """
        signal_dict = {
            ...
            "kickdown": self.kickdown_mapping
        }
        self.mf4 = self.mf4.replace(signal_dict)

    def correct_col_names(self):
        """ 
        Correct column names in the DataFrame 
        """
    ...
    def get_mf4_data(self):
        """ 
        Process and return the mf4 data 
        """
        self.load_mf4_data()
